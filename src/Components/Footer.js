...
function Footer() {
  ...
  return (
    <div style={{ backgroundColor: isDarkModeOn ? 'black' : '#D2D2D2'}}>
      <Divider />
      <footer style={{ backgroundColor: isDarkModeOn ? 'black' : '#D2D2D2', padding: '15px 0 0' }}>
        <Container>
          ...
          <ResponsiveTypography variant="h4">
            ...
            <Grid item xs={12} sm={12} md={12} textAlign="center" py={1}>
              <Typography variant="body1" style={{ textAlign: 'left',color:isDarkModeOn ? 'white':'black'}}>
        ...
        <Grid justifyContent="center" py={1}
          style={{
            backgroundColor: isDarkModeOn ? 'black' : '#D2D2D2',
            padding: '15px 0 8px',
            textAlign: 'center'
          }}
        >
            <Typography variant="body2" style={{fontSize: '12px', color: isDarkModeOn ? 'white' : 'black' }}>
