...
function BookingInformation({ currentClickTicket, setCurrentClickTicket }) {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        <Button
          onClick={() => setCurrentClickTicket(null)}
          sx={{
            position: "absolute",
            top: { xs: -80, md: 0 },
            left: { xs: -15, md: -100 },
          ...
          >
            <Box sx={{ display: { xs: "block", md: "flex" } }}>
              <Box sx={{ flexShrink: 0, textAlign: "center" }}>
                ...
                >
                  <QRCode
                    value={endpoint_url + currentClickTicket.id}
                    size={120}
                  />
                </Box>
                <Typography
                  variant="h6"
                  component="p"
                  sx={{ mt: 1, fontWeight: 600, fontWeight: 600 }}
                >
                  Admit 1 for once
                </Typography>
              </Box>
            ...
            <Box sx={{ mt: 3 }}>
              ...
              <Typography>
                <span>{currentClickTicket?.name_learner || ""}</span>
                <br />
                <span>+91-6392074436</span>
                <br />
                <span>{currentClickTicket?.email_learner || ""}</span>
                <br />
