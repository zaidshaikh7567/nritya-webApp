            ...
            >
              ...
              >
                ...
                <Box>
                  ...
                  >
                    {workshopData?.name ||
                      workshopData?.courseName ||
                      workshopData?.workshopName ||
                      workshopData?.openClassName ||
                      "Open Class Name"}
                  </Typography>
                  <br />
                  ...
                  <Box>
                      ...
                      <Grid item>
                        ...
                        >
                          {workshopData?.start_date &&
                            formatDateString(workshopData?.start_date)}{" "}
                          -{" "}
                          {workshopData?.end_date &&
                            formatDateString(workshopData?.end_date)}
                        </Typography>
                      </Grid>
                    </Grid>
                    <Grid
                    ...
                    >
                      ...
                      <Grid item>
                        ...
                        >
                          {startTime
                            ? convertTo12HourFormat(startTime) + " onwards"
                            : ""}
                        </Typography>
                      </Grid>
                    </Grid>
                    ...
                    >
                      ...
                      <Grid item>
                        ...
                        >
                          {`${workshopData?.buildingName || ""}${
                            workshopData?.buildingName ? ", " : ""
                          }${workshopData?.street || ""}${
                            workshopData?.street ? ", " : ""
                          }${workshopData?.city || "Address"}`}
                        </Typography>
                      </Grid>
                    </Grid>
                    <Grid
                    ...
                    >
                      <Grid item>
                        {inrIcon ? (
                          ...
                          <FontAwesomeIcon
                            style={{ paddingLeft: "0.35rem", color: "#735eab" }}
                      ...
                      <Grid item>
                        ...
                        >
                          {workshopData?.min_price
                            ? `${workshopData?.min_price} onwards`
                            : "Free"}
                        </Typography>
                      </Grid>
                    </Grid>
                ...
                >
                  ...
                  >
                    {currentUser
                      ? `Book @₹${workshopData?.min_price} onwards`
                      : `Login to Book @₹${workshopData?.min_price}`}
                  </Button>
                </Box>
              </Box>
          ...
          <Grid container spacing={2} alignItems="stretch">
            <Grid item xs={12} lg={8}>
              <Grid container spacing={1}>
                  ...
                  >
                    <Typography
                      ...
                      style={{
                        color: isDarkModeOn ? "white" : "black",
                        textTransform: "none",
                        borderBottom: "4px solid #735eab", // Change thickness and color here
                ...
                {/* Row 2: Kuchipudi */}
                <Grid item xs={12}>
                  {workshopData?.dance_styles &&
                    workshopData?.dance_styles.length > 0 && (
                      <>
                        {workshopData?.dance_styles
                          .split(",")
                          .map((style, index) => (
                ...
                <Grid item xs={12}>
                  <Chip
                    sx={{
                      ...
                      fontSize: "0.8rem",
                      bgcolor:
                        CHIP_LEVELS_DESIGN[workshopData?.level || "All"]
                          ?.backgroundColor, // Set the background color
                      color:
                        CHIP_LEVELS_DESIGN[workshopData?.level || "All"]?.color, // Set the text color
                      fontWeight: "bold",
                    }}
              ...
              <Grid item>
                ...
                >
                  ...
                  <Grid item xs={12} style={{ paddingTop: "2rem" }}>
                    {workshopData?.geolocation?.lat !== undefined &&
                      workshopData?.geolocation?.lng !== undefined && (
                        <Button
                          variant="contained"
                          ...
                          endIcon={
                            <img
                              ...
                              style={{
                                width: "24px",
                                height: "24px",
                                filter: isDarkModeOn ? "invert(1)" : "none",
